        ...
        <div className="App-body">
          ...
          <div className="right-panel">
            <div className="buttons">
              <h2>Schedule:</h2>
              <Button id="workScheduleButton" className="disabled" name="Work Schedule" handler={this.handleClickButton}/>
              <br/>
              <Button id="employeeSchedulesButton" className="enabled" name="Employee Schedules" handler={this.handleClickButton}/>
              <div id="modeDiv">
                <h2 id="modeLabel">Mode:</h2>
                <Button id="setUnavailableButton" className="disabled" name="Set Unavailable" handler={this.handleClickButton}/>
                <br/>
                <Button id="setScheduledButton" className="disabled" name="Set Scheduled" handler={this.handleClickButton}/>
                <br/>
                <Button id="setDisabledButton" className="disabled" name="Set Disabled" handler={this.handleClickButton}/>
              </div>
              <div id="staffDiv">
                <h2 id="StaffLabel">Staff:</h2>
                <Button id="addEmployeeButton" className="enabled" name="Add Employee" handler={this.handleAddEmployee}/>
                <br/>
